      ...
      <div className="relative z-10 mx-auto max-w-[1305px]">
        ...
        <div className="grid items-center gap-14 lg:grid-cols-[52%_48%] lg:gap-10 xl:grid-cols-[51%_49%]">
          ...
          <div className="max-w-[690px]">
            ...
            {/* Main Heading */}
            <h1 className="text-[48px] font-bold leading-[0.98] tracking-[-0.055em] text-white sm:text-[58px] md:text-[66px] lg:text-[62px] xl:text-[70px]">
              Building India's
              <br />
            ...
            {/* Description */}
            <p className="mt-8 max-w-[650px] text-[15px] leading-[1.65] text-[#bdc8c5] sm:text-[17px] sm:leading-[1.65]">
