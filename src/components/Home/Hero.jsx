...
export default function Hero() {
  ...
  return (
    <section
      ref={sectionRef}
      className={`hero-section relative min-h-screen w-full overflow-hidden bg-[#050d0f] text-white ${
      ...
      <div className="relative z-10 mx-auto min-h-screen max-w-[1800px] px-6 py-10 sm:px-10 md:px-12 lg:px-16 xl:px-[6%]">
        <div className="flex min-h-[calc(100vh-80px)] items-center">
          ...
          >
            ...
            <div
              className={`hero-badge mb-8 inline-flex items-center gap-3 rounded-full border border-[#273638] bg-[#071012]/80 px-5 py-2.5 backdrop-blur-md ${
      ...
      {"Above Ground".split("").map((letter, index) => (
        ...
        >
          {letter === " " ? "\u00A0" : letter}
            ...
            <p
              className={`hero-subtitle mt-8 text-[18px] font-normal tracking-[-0.015em] text-[#e0e6e5] sm:text-[20px] md:text-[22px] ${
                isVisible ? "animate-in" : ""
              }`}
            >
            ...
            <p
              className={`hero-description mt-5 max-w-[650px] text-[14px] leading-[1.75] text-[#929d9b] sm:text-[15px] md:text-[16px] ${
                isVisible ? "animate-in" : ""
              }`}
            >
            ...
            <div
              className={`hero-buttons mt-8 flex flex-col gap-3 sm:flex-row ${
                isVisible ? "animate-in" : ""
              }`}
            >
            ...
            <div
              className={`hero-trusted mt-16 flex items-center gap-4 ${
                isVisible ? "animate-in" : ""
              }`}
            >
